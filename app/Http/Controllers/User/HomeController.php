...
//        return view('user.pages.thanh_toan', ['cart'=>$cart, 'nguoi_dung'=>$nguoi_dung, 'tinh_thanh'=>$tinh_thanh,'km'=>$km,'gia'=>$gia]);
    ...
    public function thanh_toan(Request $rq)
    {
        ...
        DB::insert('insert into hoadon (id, MaND, NguoiNhan, SDT, id_tinh, DiaChi, TongTien, TrangThai) values (?, ?, ?, ?, ?, ?, ?, ?)', [$id_hd, Auth::user()->id, $nguoi_nhan, $rq->SDT, $rq->id_tinh, $rq->dia_chi, $rq->tong_cong, 0]);
