...
{{--        <img src="/backend/img/logo.png" alt="MONA" class="brand-image">--}}
        <h2 style="border-radius: 10px" class="badge-light text-center animation__wobble font-weight-bold">7H ADMIN</h2>
    </a>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item">
                            <a href="#" class="nav-link">
                                ...
                                <p>
                                    <?php
                                    $ho = \Illuminate\Support\Facades\Auth::user()->Ho;
                                    $tenn = \Illuminate\Support\Facades\Auth::user()->Ten;
                                    $name = $ho . $tenn;
                                    echo $name;
                                    ?>
