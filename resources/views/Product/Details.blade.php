...
<div class="humberger__menu__wrapper">
    <div class="humberger__menu__logo">
        <a href="#"><img src="oganimaster/img/logo.png" alt=""></a>
    </div>
    ...
    <div class="humberger__menu__widget">
        <div class="header__top__right__language">
            <img src="oganimaster/img/language.png" alt="">
            <div>English</div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__pic">
                    ...
                    <div class="product__details__pic__slider owl-carousel">
                        <img data-imgbigurl="oganimaster/img/product/details/product-details-2.jpg"
                             src="storage/{{$sanpham->HinhAnh1}}" alt="">
                        <img data-imgbigurl="oganimaster/img/product/details/product-details-3.jpg"
                             src="storage/{{$sanpham->HinhAnh2}}" alt="">
                        <img data-imgbigurl="oganimaster/img/product/details/product-details-5.jpg"
                             src="storage/{{$sanpham->HinhAnh3}}" alt="">
{{--                        <img data-imgbigurl="oganimaster/img/product/details/product-details-4.jpg"--}}
{{--                             src="oganimaster/img/product/details/thumb-4.jpg" alt="">--}}
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <div class="product__details__price">{{ number_format($sanpham->DonGia, 0, ',', '.') }} VNĐ</div>
                    <p>{!!$sanpham->MoTa!!}</p>
